      ...
      <div className=" h-[500px] border-2 border-red-100 w-[500px]">
        <div className=" mt-8 pl-3 pr-2 ">
          <form action="post" className=''>          
            <input placeholder="Enter Email" id='myInput'className="p-2  border-b-2  w-full outline-none focus:border-blue-700" type="text" />
            <input placeholder="Enter Password" id='myInput'className="p-2  border-b-2  w-full outline-none focus:border-blue-700" type="text" />
            ...
            <div className='mt-10 w-full h-12 bg-orange-500'>
              <Link onSubmit={handleSubmit} className=" flex justify-center w-full h-12">
